...
#spark-submit ${SRC_DIR}/index.py user__reputation__to__upvotes_cast 3 $USERS
spark-submit ${SRC_DIR}/index.py user__reputation__to__upvotes_cast 4 $USERS
#spark-submit ${SRC_DIR}/index.py user__reputation__to__upvotes_cast 5 $USERS

#spark-submit ${SRC_DIR}/index.py length__aboutme__to__user_rep 3 $USERS
spark-submit ${SRC_DIR}/index.py length__aboutme__to__user_rep 4 $USERS
#spark-submit ${SRC_DIR}/index.py length__aboutme__to__user_rep 5 $USERS

#spark-submit ${SRC_DIR}/index.py post__edits__average__to__user_rep 3 $USERS $POST_HISTORY
spark-submit ${SRC_DIR}/index.py post__edits__average__to__user_rep 4 $USERS $POST_HISTORY
#spark-submit ${SRC_DIR}/index.py post__edits__average__to__user_rep 5 $USERS $POST_HISTORY

#spark-submit ${SRC_DIR}/index.py user__membership_time__to__closed_questions 3 $USERS $POSTS $POST_HISTORY
spark-submit ${SRC_DIR}/index.py user__membership_time__to__closed_questions 4 $USERS $POSTS $POST_HISTORY
#spark-submit ${SRC_DIR}/index.py user__membership_time__to__closed_questions 5 $USERS $POSTS $POST_HISTORY

#spark-submit ${SRC_DIR}/index.py user__upvotes_cast__to__average_post_length__to__profile_views 3 $USERS $POSTS
spark-submit ${SRC_DIR}/index.py user__upvotes_cast__to__average_post_length__to__profile_views 4 $USERS $POSTS
#spark-submit ${SRC_DIR}/index.py user__upvotes_cast__to__average_post_length__to__profile_views 5 $USERS $POSTS
